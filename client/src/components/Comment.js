  ...
  return (
    <Layout>
            ...
            {userId == memberId ? (
              isCommentEditMode ? (
                <EditDelete>
                  ...
                  <div className='edit' onClick={() => handleCommentEditMode()}>
                    취소
                  </div>
                </EditDelete>
              ) : (
                <EditDelete>
                  ...
                  <div className='edit' onClick={() => handleDeleteComment()}>
                    삭제
                  </div>
                </EditDelete>
              )
      ...
      <CommentContent>
        ...
        <div className='commentlikes' onClick={() => handleCommentLike()}>
          ❤️ {commentLikeContent}
        </div>
      </CommentContent>
    </Layout>
  );
